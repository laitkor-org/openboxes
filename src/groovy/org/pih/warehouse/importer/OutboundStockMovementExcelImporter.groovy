...
class OutboundStockMovementExcelImporter extends AbstractExcelImporter {
    ...
    static Map propertyMap = [
            "origin"    : ([expectedType: ExcelImportService.PROPERTY_TYPE_STRING, defaultValue: null]),
            "destination"   : ([expectedType: ExcelImportService.PROPERTY_TYPE_STRING, defaultValue: null]),
            "productCode"       : ([expectedType: ExcelImportService.PROPERTY_TYPE_STRING, defaultValue: null]),
            "quantity": ([expectedType: ExcelImportService.PROPERTY_TYPE_INT, defaultValue: null]),
            "requestedDeliveryDate": ([expectedType: ExcelImportService.PROPERTY_TYPE_STRING, defaultValue: null]),
            "requestNumber": ([expectedType: ExcelImportService.PROPERTY_TYPE_STRING, defaultValue: null]),
    ...
    def getDataService() {
        return Holders.grailsApplication.getMainContext().getBean("outboundStockMovementDataService")
    }
