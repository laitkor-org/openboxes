...
class InventoryLevelExcelImporter extends AbstractExcelImporter {
    ...
    static Map propertyMap = [
            ...
            preferredBinLocation: ([expectedType: ExcelImportService.PROPERTY_TYPE_STRING, defaultValue: null]),
            ...
            expectedLeadTimeDays : ([expectedType: ExcelImportService.PROPERTY_TYPE_INT, defaultValue: null]),
            replenishmentPeriodDays : ([expectedType: ExcelImportService.PROPERTY_TYPE_INT, defaultValue: null]),
    ...
    InventoryLevelExcelImporter(String fileName) {
        super(fileName)
        dataService = Holders.grailsApplication.getMainContext().getBean("dataService")
    }
