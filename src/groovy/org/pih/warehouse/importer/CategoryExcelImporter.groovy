...
class CategoryExcelImporter extends AbstractExcelImporter {
    ...
    CategoryExcelImporter(String fileName) {
        super(fileName)
        categoryDataService = Holders.grailsApplication.getMainContext().getBean("categoryDataService")
        // ApplicationHolder.getApplication().getMainContext().getBean("categoryDataService")
    }
