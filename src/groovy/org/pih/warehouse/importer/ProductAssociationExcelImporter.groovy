...
class ProductAssociationExcelImporter extends AbstractExcelImporter {
    ...
    static Map propertyMap = [
            ...
            "product.name"                  : ([expectedType: ExcelImportService.PROPERTY_TYPE_STRING, defaultValue: null]),
            "associatedProduct.productCode" : ([expectedType: ExcelImportService.PROPERTY_TYPE_STRING, defaultValue: null]),
            "associatedProduct.name"        : ([expectedType: ExcelImportService.PROPERTY_TYPE_STRING, defaultValue: null]),
            "conversion"                      : ([expectedType: ExcelImportService.PROPERTY_TYPE_INT, defaultValue: null]),
            "comments"                      : ([expectedType: ExcelImportService.PROPERTY_TYPE_STRING, defaultValue: null]),
            "hasMutualAssociation"          : ([expectedType: ExcelImportService.PROPERTY_TYPE_STRING, defaultValue: "no"]),
    ]
    ...
    def getDataService() {
        return Holders.grailsApplication.getMainContext().getBean("productAssociationDataService")
    }
