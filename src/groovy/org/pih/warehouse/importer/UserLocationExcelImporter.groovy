...
class UserLocationExcelImporter extends AbstractExcelImporter {
    ...
    static Map propertyMap = [
            ...
            locationName: ([expectedType: ExcelImportService.PROPERTY_TYPE_STRING, defaultValue: null]),
            roleName    : ([expectedType: ExcelImportService.PROPERTY_TYPE_STRING, defaultValue: null])
    ]
    ...
    def getDataService() {
        return Holders.grailsApplication.getMainContext().getBean("userLocationDataService")
